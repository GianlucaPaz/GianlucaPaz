...
def generate_svg(entries):
  ...
  <rect width="{card_width}" height="{card_height}" rx="6" fill="#151515" stroke="#FFFFFF" stroke-width="1"/>
  <text x="{padding_x}" y="{title_y}" fill="#FFFFFF" font-family="Arial, Helvetica, sans-serif" font-size="18" font-weight="400">
