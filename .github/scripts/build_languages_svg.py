...
def generate_svg(entries):
    ...
    # Ajustes verticais para o conteúdo "descer" um pouco
    title_y = 34
    bar_x = padding_x
    bar_y = 58
    bar_width = 348
    ...
    # Altura mínima fixa para ficar parecida com o card da esquerda
    content_height = 100 + rows * 28 + 20
    card_height = max(180, content_height)
